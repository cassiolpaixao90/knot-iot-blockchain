    ...
    _onMessage(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [total] = yield index_1.WaterFlowRepo.aggregate([
                ...
                { $match: { uuid, month: moment_timezone_1.default().month() + 1 } },
                { $group: { _id: null, flowRate: { $sum: '$flowRate' } } }
            ]);
            const device = yield index_1.DeviceRepo.findById(uuid).lean();
...
exports.KnotAccess = KnotAccess;
//# sourceMappingURL=KnotDataAgent.js.map